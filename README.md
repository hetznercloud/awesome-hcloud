...
- [bex](https://github.com/bex-co/bex) — The open-source Render alternative, AI-native. Git push → build → deploy on Kubernetes clusters provisioned on Hetzner Cloud via Cluster API Provider Hetzner (CAPH).
...
- [karpenter-provider-hetzner](https://github.com/paperclipinc/karpenter-provider-hetzner) — Karpenter node autoprovisioning for Hetzner Cloud: launches the cheapest server that fits pending pods and consolidates idle nodes. By [Paperclip.inc](https://paperclip.inc/blog/karpenter-hetzner).
...
- [ui-driver-hetzner](https://github.com/mxschmitt/ui-driver-hetzner) — Rancher UI driver for the Hetzner Cloud docker-machine-driver — ⚠️ Deprecated
